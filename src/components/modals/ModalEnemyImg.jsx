  ...
  const handleUploadImage = async (id) => {
    try {
      ...
      if (formImg) {
        ...
        const id_enemy = id ? id.toString() : null
        console.log('id_enemy: ', id_enemy)
        if (id_enemy) {
          const response = await postEnemyImage(id_enemy, formImg, token)
          console.log('response', response)
          if (response !== null) {
            console.log('Immagine caricata correttamente', response)
            console.log('id nemico', id)
            console.log('altro id nemico', id_enemy)
            dispatch({
