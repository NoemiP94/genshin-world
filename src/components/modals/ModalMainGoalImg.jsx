  ...
  const handleUploadImage = async (id) => {
    try {
      ...
      if (formImg) {
        ...
        const id_mainGoal = id ? id.toString() : null
        console.log('id_mainGoal: ', id_mainGoal)
        if (id_mainGoal) {
          const response = await postMainGoalImage(id_mainGoal, formImg, token)
          console.log('response', response)
          if (response !== null) {
            console.log('Immagine caricata correttamente', response)
            console.log('id mainGoal', id)
            console.log('altro id mainGoal', id_mainGoal)
            dispatch({
          ...
          console.log('MainGoal ID not recovered')
        }
      }
    } catch (error) {
...
export default ModalMainGoalImg
