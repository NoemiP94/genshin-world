...
const ModalImgBlogpost = ({
  ...
  const handleUploadImage = async (id) => {
    try {
      console.log('cliccato'), console.log('id blog', id)
      console.log(blogId)

      if (formImg) {
        console.log('formImg', formImg)
        const id_blog = id ? id.toString() : null
        console.log('id_blog: ', id_blog)
        if (id_blog) {
          const response = await postBlogpostImage(id_blog, formImg, token)
          console.log('response', response)
          if (response !== null) {
            console.log('Immagine caricata correttamente', response)
            console.log('id blog', id)
            console.log('altro id blog', id_blog)
            dispatch({
...
export default ModalImgBlogpost
