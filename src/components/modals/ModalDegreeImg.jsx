...
const ModalDegreeImg = ({ showImgModal, setShowImgModal, degreeId }) => {
  ...
  const handleUploadImage = async (id) => {
    try {
      console.log('cliccato'), console.log('id grado', id)
      ...
      if (formImg) {
        ...
        if (id_degree) {
          ...
          if (response !== null) {
            ...
            console.log('altro id degree', id_degree)
            dispatch({
          ...
          console.log('Degree ID not recovered')
        }
      }
    } catch (error) {
